...
import com.hzwl.videoview.model.DataOfPage;
...
public class JsonParse {
    ...
    public static ResultInfo parseToResultInfo(Context context, String result) {
        ...
        if (result == null) {
            info = new ResultInfo(R.string.serviceError, context.getString(R.string.serviceError));
            return info;
        }
        ...
        try {
            ...
            info = new ResultInfo(R.string.dataError, context.getString(R.string.dataError));
        }
        return info;
    }
